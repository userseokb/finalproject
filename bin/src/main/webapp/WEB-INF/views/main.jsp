            ...
            <div class="container px-4 px-lg-5 mt-5">
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-body p-3">
                                <div class="text-left">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">술마켓 더한 서울의밤 매실증류주25도 375ml</h5>
                                    <!-- Product price-->
                                    ₩7,900
                                </div>
                            </div>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- best badge-->
                            <div class="position-absolute"><img class="best-banner" src=../resources/image/best.jpg style="width: 50px;height: 50px;" alt="..." /></div>
                            <!-- Product image-->
