                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item dropdown">
                       		 <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">우리술한눈에보기</a>
                       		 <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                       		 	<li><a class="dropdown-item" href="/category/A">소주/증류주</a></li>
                       		 	<li><a class="dropdown-item" href="/category/${product.categoryCode}">리큐르</a></li>
                       		 	<li><a class="dropdown-item" href="/category/${product.categoryCode}">막걸리</a></li>
                       		 	<li><a class="dropdown-item" href="/category/${product.categoryCode}">약주/청주</a></li>
                      		 </ul>
                        </li>
